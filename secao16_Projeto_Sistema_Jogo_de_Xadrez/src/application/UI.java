...
//		System.out.println("Aguardando jogador: " + chessMatch.getCurrentPlayer());
	...
	// mudar a cor que aparece no aguardando jogador
	private static String printCurrentPlayer(Color currentPlayer) {
		if (currentPlayer == Color.WHITE) {
			return ANSI_WHITE + currentPlayer + ANSI_RESET;
		} else {
			return ANSI_YELLOW + currentPlayer + ANSI_RESET;
		}
	}
